...
$.SOW.config.autoinit['fullcalendar'] = ['$.SOW.vendor.fullcalendar.init','.fullcalendar', {plugins:["interaction","dayGrid","timeGrid","list","bootstrap","googleCalendar"],editable:true,eventLimit:true,locale:"en",themeSystem:"bootstrap",defaultView:"dayGridMonth",defaultDate:"2020-08-11T15:33:38.858Z",timeZone:"UTC",header:{left:"prev,next today, addEventButton",center:"title",right:"dayGridMonth,timeGridWeek,timeGridDay,listWeek"},buttonText:{today:"today",month:"month",week:"week",day:"day",list:"list"},eventTimeFormat:{hour:"numeric",minute:"2-digit",meridiem:"short"}},true];
